...
setTimeout(this.changeGameover,100)
 ...
 this.state.WhichPlayer===1 ? this.setState({WhichPlayer:-1}):this.setState({WhichPlayer:1})
  ...
  this.arr=this.state.game.slice()
  this.arr[x]=this.state.WhichPlayer
this.setState({
  game:this.arr
})
this.setState({
...
//computer
this.xArray=[0,1,2,3,4,5,6,7,8]
this.rey=this.xArray.filter((age)=>{return age!==x})
...
if(x===0){
      ...
      if(this.state.game[1]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
        this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
        this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
        this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
        this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
        ...
        this.state.game[0]+this.state.game[4]+this.state.game[8]!==-3  &&
        this.state.game[2]+this.state.game[4]+this.state.game[6]!==-3){
      this.arr[1]=this.state.WhichPlayer
      this.setState({
      
      game:this.arr,
      WhichPlayer:1
      })}
      else if(this.state.game[4]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
        this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
        this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
        this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
        this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
        ...
        this.state.game[0]+this.state.game[4]+this.state.game[8]!==-3  &&
        this.state.game[2]+this.state.game[4]+this.state.game[6]!==-3){
      this.arr[4]=this.state.WhichPlayer
      this.setState({
      
      game:this.arr,
      WhichPlayer:1
      })}
      else if(this.state.game[3]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
        this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
        this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
        this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
        this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
        ...
        this.state.game[0]+this.state.game[4]+this.state.game[8]!==-3  &&
        this.state.game[2]+this.state.game[4]+this.state.game[6]!==-3){
      this.arr[3]=this.state.WhichPlayer
      this.setState({
...
if(x===1){
      if(this.state.game[0]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
        this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
        this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
        this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
        this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
        ...
        this.state.game[0]+this.state.game[4]+this.state.game[8]!==-3  &&
        this.state.game[2]+this.state.game[4]+this.state.game[6]!==-3){
      this.arr[0]=this.state.WhichPlayer
      this.setState({
      ...
      WhichPlayer:1
      ...
      else if(this.state.game[2]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
        this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
        this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
        this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
        this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
        ...
        this.state.game[0]+this.state.game[4]+this.state.game[8]!==-3  &&
        this.state.game[2]+this.state.game[4]+this.state.game[6]!==-3){
      this.arr[2]=this.state.WhichPlayer
      this.setState({
...
if(x===2){
  ...
  WhichPlayer:1
  ...
  else if(this.state.game[5]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
    this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
    this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
    this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
    this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
    ...
    this.state.game[0]+this.state.game[4]+this.state.game[8]!==-3  &&
    this.state.game[2]+this.state.game[4]+this.state.game[6]!==-3){
  this.arr[5]=this.state.WhichPlayer
  this.setState({
...
if(x===3){
      ...
      WhichPlayer:1
      ...
      else if(this.state.game[6]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
        this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
        this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
        this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
        this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
        ...
        this.state.game[0]+this.state.game[4]+this.state.game[8]!==-3  &&
        this.state.game[2]+this.state.game[4]+this.state.game[6]!==-3){
      this.arr[6]=this.state.WhichPlayer
      this.setState({
...
if(x===4){
  ...
  WhichPlayer:1
  ...
  else if(this.state.game[7]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
    this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
    this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
    this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
    this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
    ...
    this.state.game[0]+this.state.game[4]+this.state.game[8]!==-3  &&
    this.state.game[2]+this.state.game[4]+this.state.game[6]!==-3){
  this.arr[7]=this.state.WhichPlayer
  this.setState({
...
if(x===5){
  if(this.state.game[2]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
    this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
    this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
    this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
    this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
  ...
  WhichPlayer:1
  ...
  else if(this.state.game[8]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
    this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
    this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
    this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
    this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
    ...
    this.state.game[0]+this.state.game[4]+this.state.game[8]!==-3  &&
    this.state.game[2]+this.state.game[4]+this.state.game[6]!==-3){
  this.arr[8]=this.state.WhichPlayer
  this.setState({
...
if(x===6){
  if(this.state.game[3]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
    this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
    this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
    this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
    this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
...
if(x===7){
  if(this.state.game[6]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
    this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
    this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
    this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
    this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
...
if(x===8){
  ...
  if(this.state.game[7]===0&&this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
    this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
    this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
    this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
    this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
  ...
  renderPlayerTurn(){
    if(this.state.WhichPlayer===-1&& this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
      this.state.game[3]+this.state.game[4]+this.state.game[5]!==3 &&
      this.state.game[6]+this.state.game[7]+this.state.game[8]!==3  &&
      this.state.game[0]+this.state.game[3]+this.state.game[6]!==3  &&
      this.state.game[1]+this.state.game[4]+this.state.game[7]!==3  &&
    ...
    else if(this.state.WhichPlayer===1 && this.state.game[0]+this.state.game[1]+this.state.game[2]!==3 &&
      this.state.game[3]+this.state.game[4]+this.state.game[5]!==-3 &&
      this.state.game[6]+this.state.game[7]+this.state.game[8]!==-3  &&
      this.state.game[0]+this.state.game[3]+this.state.game[6]!==-3  &&
      this.state.game[1]+this.state.game[4]+this.state.game[7]!==-3  &&
